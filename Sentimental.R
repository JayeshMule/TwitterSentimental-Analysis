...
library(stringr)
library(ggplot2)
api_key <- 'j51rEFN5To6mDr00cLdSQgSmW'
api_secret <- 'j7SJppRVoxYKkE9snPtCggcdogsYUGKEs3gZZY2NWAoNgd3ckH'
access_token <- "1310867276-W2glHwYnubGl0w3HpKQZ7bEgq6OE3zje0NOGJuk"
access_token_secret <- "Ub2k1CZsXnkFOcYzkMPUmFJe8E2CNhOwdiigMqtrFU5FI"
